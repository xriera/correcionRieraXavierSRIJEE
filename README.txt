...
a persistence unit "correcionRieraXavierSRIJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "correcionRieraXavierSRIJEE\pom.xml":
...
artifact ("correcionRieraXavierSRIJEE.war") is already built. You can build
